...
def main():
    ...
    parser.add_argument('--input-dir', '-i', default='candidates_v2', help='Directory used for the scan (v2)')
    parser.add_argument('--pruned-dir', '-p', default='candidates_v3', help='Directory with pruned PDBs (v3)')
