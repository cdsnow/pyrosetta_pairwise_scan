...
def main():
    ...
    parser.add_argument('--output-dir', default='batches_prune_v4')
    parser.add_argument('--target-dir', default='candidates_v4')
    ...
    for i in range(args.num_batches):
        ...
        # Run in parallel
        cmd = f"python3 prune_candidates.py --results {batch_file} --output-dir {args.target_dir} --verbose > {log_file} 2>&1"
        bash_lines.append(cmd)

    run_script = "run_prune_batches_v4.sh"
    with open(run_script, "w") as f:
        f.write("#!/bin/bash\n")
        f.write("# Generated by prepare_prune_batches_v4.py\n\n")
        f.write("echo 'Starting pruning batches v4...'\n")
